...
- An accepted later steer supersedes conflicting requirements in an initial briefing. Inspect the owner's recent turns before treating the original heading or other original content as the current requirement. If a spoken folder name does not resolve, inspect the actual parent directory and recorded task working directories before announcing that it is absent; resolve a clear transcription variation against that evidence, or ask for clarification when more than one target remains plausible.
