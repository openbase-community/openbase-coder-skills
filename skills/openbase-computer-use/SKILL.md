...
| Openbase Coder Claude session on macOS | [openbase-claude-macos.md](openbase-claude-macos.md) |
...
- If you have `mcp__openbase-computer-use__*` tools available (Claude Code
  sessions started by Openbase Coder — the built-in suite never attaches to
  headless sessions) → use [openbase-claude-macos.md](openbase-claude-macos.md).
